...
const careerNodes: CareerNode[] = [
  {
    ...
    result: "问答式结果覆盖可观比例的搜索需求；具体数据已脱敏。",
  },
  {
    id: "game",
    title: "游戏分发",
    ...
    result: "小游戏形成大规模日活；重度游戏日激活与可归因年流水达到可观规模；具体数据已脱敏。",
  },
  {
    id: "image-text",
    title: "图文推荐",
    ...
    result: "图文 DAU 显著增长，频道与社区均达到大规模覆盖；具体数据已脱敏。",
  },
  {
    id: "monetization",
    title: "作者变现",
  ...
  },
  {
    ...
    problem: "作者收入问题过去太依赖运营和管理者的人工经验。",
    action: "把作者阶段、收入结构、变现方式和问题诊断结构化。",
    ability: "作者挖掘模型、自动化流量分配、作者收入智能体。",
