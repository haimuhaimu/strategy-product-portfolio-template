...
const projectNarratives: Record<string, ProjectNarrative> = {
  ...
  "paid-content-evaluation-typing": {
    ...
    openingParagraphs: [
      "精选会员本质上是一类内容付费模式，关键是识别能持续供给付费价值的作者，并匹配合适的流量策略。",
      "过去这类工作通常需要 1 名数据分析师或 1 名算法同学写 SQL、制定策略；现在产品和运营已能借助 AI 内容理解与自动化策略自行完成。",
      "这不是未来设想：能力已覆盖全量业务作者，量级为几十万，相关策略已经实际应用。",
      "具体转化、收入和留存没有公开确认，因此这里只把已发生的工作方式变化和采用事实作为结果。",
    ],
    openingHighlight:
      "已发生的核心变化，是把逐次依赖专业支持的作者挖掘，转成产品和运营可直接使用、覆盖全量作者的策略能力。",
    ...
    aiClosing: "已发生的是 AI 内容理解、自动化策略和全量应用；策略治理平台属于今天重做的下一步。",
  },
