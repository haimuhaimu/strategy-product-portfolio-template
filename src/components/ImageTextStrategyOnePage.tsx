const scenes = [
  {
    label: "01",
    title: "单列主场景",
    subtitle: "在短视频主 feed 里证明图文能被有效消费",
  ...
  },
  {
    label: "03",
    title: "UGC 图文社区",
    subtitle: "从主站体裁增长，走到独立社区冷启",
    tension: "独立社区早期最难的不是灌流量，而是用户第一眼能不能看到稳定、匹配、有消费价值的内容。",
    strategy: "建设内容池、频道候选集、新用户兴趣画像和首刷承接路径，让社区能开始转起来。",
    proof: "社区 DAU 百万级规模",
  },
];
